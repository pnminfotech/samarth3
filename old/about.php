				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12 order-2 wow fadeInRight" data-wow-delay="600ms">
					<div class="inner-column">
						<div class="sec-title" style="margin-bottom: 0px;">
							...
							<div class="text">We are growing trading firm Estb year 2016, working in multiple area as a solution provider in industrial segment. We study your need and provide optimal praposal for same.

We mainly into Overall Cutting tools, Industrial Oil, with association directly with principals like Magnus Lubricant, Nandan Petrolium, BrugarOlas which deals all types of industrial oil, also Carmex India, Kyocera, Motherson Techno tools, Karbit, Rudrali in Cutting tools.
<br>
						...
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								<div class="feature-block-two">
									...
									<span class="fa fa-check"></span> Large output.<br>
									<span class="fa fa-check"></span> Fast delivery.<br>
									<span class="fa fa-check"></span> High-quality products.<br>
									<span class="fa fa-check"></span> Reasonable price.<br>
									<span class="fa fa-check"></span> Sincere service.<br></p>
								</div>
							</div>
						</div>
